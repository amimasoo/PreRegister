                ...
                <div class="card-body" style="float: right; text-align: right">
                    ...
                    <form method="post" action="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <lable for="courseName" class="col-md-4 col-form-label" style="float: right;text-align: right">نام درس</lable>
                                <input name="courseName" id="courseName" class="form-control{{ $errors->has('courseName') ? ' is-invalid' : '' }} col-md-8" type="text" style="text-align: right" title="نام درس">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                ...
                                <input name="courseCode" id="courseCode" class="form-control{{ $errors->has('courseCode') ? ' is-invalid' : '' }} col-md-8" type="number" style="text-align: right" title="کد درس">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                ...
                                <input name="courseUnit" id="courseUnit" class="form-control{{ $errors->has('courseUnit') ? ' is-invalid' : '' }} col-md-8" type="number" style="text-align: right" title="واحد درس">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                ...
                                <input name="deptID" id="deptID" class="form-control{{ $errors->has('deptID') ? ' is-invalid' : '' }} col-md-8" type="number" style="text-align: right" title="شماره گروه">
