                ...
                fit: function () {
                    ...
                    if (o.display && h) {
                        ...
                        if (p) {
                            ...
                            var C = c(t.ctx, i[0], f.font), T = c(t.ctx, i[i.length - 1], f.font);
                ...
                draw: function (t) {
                    ...
                    if (i.display) {
                        var o = e.ctx, r = n.global, s = i.ticks.minor, c = i.ticks.major || s, h = i.gridLines,
                            ...
                            k = a.valueOrDefault(p.fontColor, r.defaultFontColor), S = u(p),
                            C = a.options.toPadding(p.padding), T = a.toRadians(e.labelRotation), M = [],
                            I = e.options.gridLines.lineWidth, P = "right" === i.position ? e.left : e.right - I - w,
...
dropdownSelectors.on({
    ...
    var e, i = "input[type=range]:not(.custom-range)", n = !1;
